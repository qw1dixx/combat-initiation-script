...
local Window = Rayfield:CreateWindow({
   Name = "Combat Initation Script",
   Icon = 0, 
   LoadingTitle = "Fuck niggers",
   LoadingSubtitle = "created By qw1dixx",
   Theme = "Default", 
...
local function modifyToolAttributes(toolName, attributes)
    ...
    if tool then
        ...
        Rayfield:Notify({
   Title = "Script",
   Content = toolName .. " attributes have been set.",
   Duration = 6.5,
   Image = 4483362458,
})
    else
        Rayfield:Notify({
   Title = "Script",
   Content = toolName .. " not found in the Backpack or equipped.",
   Duration = 6.5,
   Image = 4483362458,
})
    end
...
Tab:CreateButton({
	Name = "Modded Superball(плохо работает)",
	Callback = function(Value)
...
Tab:CreateButton({
	Name = "Modded Ninja Stars (плохо работает)",
	Callback = function(Value)
...
Tab:CreateButton({
	Name = "Modded Bazooka(плохо работает)",
	Default = false,
	Flag = "Bazooka",
	Callback = function()
...
Tab:CreateButton({
	Name = "Modded Subspace Tripmine(плохо работает)",
	Default = false,
...
Tab:CreateButton({
	Name = "Modded Explosive Pinata(плохо работает)",
	Callback = function(Value)
...
Rayfield:Notify({
   Title = "Script",
   Content = "Wrench not found in the Backpack or equipped.",
   Duration = 6.5,
   Image = 4483362458,
})
		end
...
Tab2:CreateButton({
	...
	Callback = function()
		...
		if accessoryEffects then
			...
			Rayfield:Notify({
   Title = "Script",
   Content = "AccessoryEffects not found.",
   Duration = 6.5,
   Image = 4483362458,
})
		end
...
Tab5:CreateParagraph({Title = "qw1dixx", Content = "Made by"})
